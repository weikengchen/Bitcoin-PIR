//! Two-Phase DPF-PIR Client for UTXO Lookup (WebSocket Version) - Gen2
//!
...
//!
//! Usage:
//!   cargo run --bin lookup_pir2 -- <script_hex_or_hash> [--hash]
//!
//! Example:
//!   cargo run --bin lookup_pir2 -- 76a914e4986f7364f238102f1889ef9d24d80e2d2d7a4488ac
//!   cargo run --bin lookup_pir2 -- 09d9fb5e2c298cdf69a06fdc188334305e9cb20d --hash
...
const CUCKOO_DB_ID: &str = "gen2_utxo_cuckoo_index";

/// Database ID for the chunks data
const CHUNKS_DB_ID: &str = "gen2_utxo_chunks_data";
...
fn print_help(program: &str) {
    println!("Two-Phase DPF-PIR Client for UTXO Lookup (WebSocket Version) - Gen2");
    println!();
    println!("Usage:");
...
async fn main() {
    ...
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║       Two-Phase DPF-PIR UTXO Lookup (WebSocket) Gen2       ║");
    println!("╠══════════════════════════════════════════════════════════════╣");
