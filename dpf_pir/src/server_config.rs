...
pub fn load_configuration(small: bool) -> ServerConfiguration {
    ...
    let cuckoo_path = if small {
        "/Volumes/Bitcoin/data/utxo_chunks_cuckoo_small.bin"
    } else {
        "/Volumes/Bitcoin/data/utxo_chunks_cuckoo.bin"
    };
    ...
    let chunks_path = if small {
        "/Volumes/Bitcoin/data/utxo_chunks_small.bin"
    } else {
        "/Volumes/Bitcoin/data/utxo_chunks.bin"
    };
